...
中文简介：钮鑫涛，准聘副教授，博士生导师，于2019年获得南京大学博士学位。主要研究方向为软件测试与分析、程序分析与自动化调试，以及智能系统可信评估，近期关注组合测试、Datalog 程序调试、增量构建系统和深度学习系统测试。

我们常年招收本科生、硕士生和博士生，如果想成为我们团队的一员，不妨先看一下[这个页面](/join-us/)。如果对软件测试等领域感兴趣的话，也欢迎随时联系。

I am currently a Tenure-track Associate Professor at School of Intelligent Software and Engineering, Nanjing University. Before joining School of Intelligent Software and Engineering, I was an Assistant Researcher at [Department of Computer Science and Technology](https://cs.nju.edu.cn/), [Nanjing University](https://www.nju.edu.cn/). I am also part of the [Group in Software Testing (GIST)](http://gist.nju.edu.cn/). My research interests lie in software testing and analysis, program analysis and automated debugging, and trustworthiness evaluation of intelligent systems, with recent work on combinatorial testing, Datalog program debugging, incremental build systems, and deep learning system testing.
