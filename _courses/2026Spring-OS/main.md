...
- 时间：1班 周四 5-7节， 2班 周五 2-4节
- 地点：苏教A207
- QQ群：1班 1087708643，2班 1087708196（申请加入需提供院系、姓名、学号）
...
| 日期      | 课件                                                         | 作业 | 相关代码 |
| --------- | ------------------------------------------------------------ | ---- | -------- |
| 2026/3/5 | [1.[绪论]操作系统概述](/assets/pdf/2026Spring-OS/1.[绪论]操作系统概述.pdf) |      |          |
| 2026/3/12 | [2.[绪论]操作系统的各种视角](/assets/pdf/2026Spring-OS/2.[绪论]操作系统的各种视角.pdf) |      |          |
| 2026/3/19 | [3.[并发]多处理器编程](/assets/pdf/2026Spring-OS/3.[并发]多处理器编程.pdf) |      |          |
| 2026/3/26 | [4.[并发]互斥](/assets/pdf/2026Spring-OS/4.[并发]互斥.pdf) |      |          |
| 2026/4/2 | [5.[并发]互斥_进阶](/assets/pdf/2026Spring-OS/5.[并发]互斥_进阶.pdf) |      |          |
| 2026/4/9 | [6.[并发]同步](/assets/pdf/2026Spring-OS/6.[并发]同步.pdf) |      |          |
| 2026/4/16 | [7.[并发]同步_进阶](/assets/pdf/2026Spring-OS/7.[并发]同步_进阶.pdf) |      |          |
| 2026/4/23 | [8.[并发]并发bugs](/assets/pdf/2026Spring-OS/8.[并发]并发bugs.pdf) |      |          |
| 2026/4/30 | [9.[虚拟化]进程](/assets/pdf/2026Spring-OS/9.[虚拟化]进程.pdf) |      |          |
| 2026/5/7 | [10.[虚拟化]调度](/assets/pdf/2026Spring-OS/10.[虚拟化]调度.pdf) |      |          |
| 2026/5/14 | 停课 |      |          |
| 2026/5/21 | [11.[虚拟化]地址空间](/assets/pdf/2026Spring-OS/11.[虚拟化]地址空间.pdf) |      |          |
| 2026/5/28 | [12.[虚拟化]地址空间_续](/assets/pdf/2026Spring-OS/12.[虚拟化]地址空间_续.pdf) |      |          |
| 2026/6/4 | [13.[持久化]设备管理](/assets/pdf/2026Spring-OS/13.[持久化]设备管理.pdf) |      |          |
| 2026/6/11 | [14.[持久化]文件系统](/assets/pdf/2026Spring-OS/14.[持久化]文件系统.pdf) |      |          |

<br/>

##### 考核方式

- 编程实验(利用系统api解决某个具体问题): 60%
- 期末考试: 40% (闭卷考试)
