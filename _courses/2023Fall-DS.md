...
| 3.查找及相关问题   | 2023/10/19<br />2023/10/26<br />2023/11/2<br />2023/11/9 | [8.树](/assets/pdf/2023Fall-DS/8.树.pdf) [9.搜索树](/assets/pdf/2023Fall-DS/9.搜索树.pdf)<br /> [9.搜索树(续)](/assets/pdf/2023Fall-DS/9.搜索树(续).pdf)  [补充：skiplist height expectation](/assets/pdf/2023Fall-DS/skiplist height expectation.pdf)<br /> [10.散列表](/assets/pdf/2023Fall-DS/10.散列表.pdf)<br /> [11.平摊分析](/assets/pdf/2023Fall-DS/11.平摊分析.pdf) |
| 4.图算法           |                                                          |                                                              |
| 5.动态规划         |                                                          |                                                              |
| 6.高级算法（选讲） |                                                          |                                                              |
